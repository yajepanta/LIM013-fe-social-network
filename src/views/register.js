    ...
    <form> <!-- action='/action_page.php' -->
      <ul class='form-flex'>
        ...
        <li>
          ...
          <p class='msg-error-pass hidden'> ⚠️ Las contraseñas no coinciden </p>
          <button type="button" id='btn-return' class='btn-ingresar'><</button>
          <button type="button" id='btn-register' class='btn-ingresar'>REGISTRARTE</button>
        </li>  
      </ul> 
    </form>
 `;
